...
if (window.ue_ihb === 1) {
var ue_hob=+new Date();
var ue_id='GS11C6Q0922HC0M7BYN7',
ue_csm = window,
...
var ue_url='/gp/help/customer/display.html/uedata/unsticky/356-1298069-6592723/GPHelp/ntpoffrw',
...
ue_fcsn=1,
ue_isrw=true,
ue_fpf='//fls-fe.amazon.co.jp/1/batch/1/OP/A1VC38T7YXB528:356-1298069-6592723:GS11C6Q0922HC0M7BYN7$uedata=s:',
ue_qsl=7000,
ue_rpl_ns=0,
ue_orct=1,
ue_int=0,
...
<!-- 4p5ez7ii9f88kcpfenabwcb216jg5rovhp0jo7jliw00v5a4n6sbphol2f0v45opcq0x0d3lxu8ogim1cpsk0f2dxq30bgytlngvs4dbbcbpvqtvfhgfvowuex3o8tip9yfp31piv38j87v2up1qh5ckkcwrszhupomwp9vlxejlcypokp7gjrgr9 -->
...
<link rel="stylesheet" href="https://images-fe.ssl-images-amazon.com/images/I/211a2KBo3oL.css?AUIClients/CSHelpGatewayCSS">
...
<script>
  (window.AmazonUIPageJS ? AmazonUIPageJS : P).load.js('https://images-fe.ssl-images-amazon.com/images/I/51hBdbYwbOL.js?AUIClients/CSHelpOmnitureJS');
</script><script type="text/javascript" async="" crossorigin="anonymous" src="https://images-fe.ssl-images-amazon.com/images/I/51hBdbYwbOL.js?AUIClients/CSHelpOmnitureJS"></script>



<script language="JavaScript" type="text/javascript">
   <!--
var csHelpOmnitureAccountName = 'acsjp-prod';

if (typeof csHelpOmniture === 'undefined') { csHelpOmniture = {}; }


csHelpOmniture.setupHMDWidget = function() {

   if (window.P && window.P.AUI_BUILD_DATE) {

      P.when("A").register("csHelpOmniture", function() {

         return {
            storeHMDResults: function(wasHelpful, feedbackKind, freeformText) {
               s.linkTrackVars = 'events,eVar53,eVar54,eVar56';
               s.linkTrackEvents = 'event30,event31';
               s.events   = "event31"; // Assume "yes".
               s.pageName = "508510";

               if (! wasHelpful) {
                  s.events = "event30";
                  s.eVar53 = feedbackKind;

                  // Not for Phase I.  s.eVar56 = freeformText; //TODO:  right var name?
               }

               s.eVar54 = "0";

               if (s.tl) {
                  s.tl(/*objectBeingClickedOrTrue=>*/ true,
                       /*linkType=>Custom Links*/     "o",
                       /*linkName=>*/                 "Digital HMD Widget");
               }
            }
         }
      });
...
csHelpOmniture.event = function(omnitureObjJson, jQuery) {
    ...
    s.prop14 = 'ヘルプ';
    // The first H1 entry takes precedence over the encoded title value, if present.
    var firstH1 = '';
    // Migrate to Help 4.0, need to compatible with Help 3.0, will delete else branch once Help 4.0 fully launched
    if (jQuery('.cs-help-content h1:first').length) {
        if (jQuery('.cs-help-content h1:first img').length) {
            if ( jQuery('.cs-help-content h1:first img').attr("alt") !== undefined ) {
                firstH1 = jQuery('.cs-help-content h1:first img').attr("alt").replace(/["'`\r\n]/g, '');
            }
        } else {
            firstH1 = jQuery('.cs-help-content h1:first').text().replace(/["'`\r\n]/g, '');
        }
    } else {
        firstH1 = jQuery('.center-col h1:first').text();
    }

    if ( firstH1 ) { s.prop14 = firstH1; }

    s.prop15 = 'CS_HELP_GATEWAY_SS_V2_57525:T3'; // Store any useful weblab settings here, uncomment when we need it
    // Append Help 3.0 / 4.0 flag
    if (jQuery('.cs-help-content').length) {
        s.prop15 += '|HELP_VERSION:4.0';
    } else {
        s.prop15 += '|HELP_VERSION:3.0';
    }
    s.list1 = s.prop15;

    s.prop37 = '0'; // encrypted customer id
    s.eVar37 = s.prop37;

    s.prop38 = '356-1298069-6592723'; // session id
    s.eVar38 = s.prop38;


    s.prop41 = 'ja_JP';  // TO-DO: find correct variable name.
    s.eVar41 = s.prop41;
    s.eVar44 = s.prop14;


    var mobileSubTopicNodes;
    if (jQuery('div.a-touch .cs-help-content .a-box-group a').length) {
        mobileSubTopicNodes = jQuery('div.a-touch .cs-help-content .a-box-group a');
        mobileSubTopicNodes.click(
        function(e) {
            var s = s_gi('acsjp-prod');
            s.linkTrackVars = 'prop44';

            var link = jQuery(this);
            var position = mobileSubTopicNodes.index(jQuery(this)) + 1;
            s.prop44 = link.text() + ":" + position;

            s.tl(this,'o');
        }
        );
    }
    var mobileTopicH2Nodes;
    if (jQuery('a.a-expander-header').length) {
        mobileTopicH2Nodes = jQuery('a.a-expander-header');
        mobileTopicH2Nodes.click(
        function(e) {
            if ( ! mobileTopicH2Nodes.children('i.a-icon-section-collapse').length ) return;
            var s = s_gi('acsjp-prod');
            s.linkTrackVars = 'prop45,eVar45';
            s.linkTrackEvents =' event1,event2,event3,event4,event5,event6,event7,event21';
            s.events = 'event21';
            ...
            s.tl(this,'o', link.text());
        }
        );
    }
    var firstThreeSearchResultNodes;
    if (jQuery('.results-list').length) {
        firstThreeSearchResultNodes = jQuery('.results-list').children('li:lt(3)').find('a');
    } else {
        firstThreeSearchResultNodes = jQuery('.cs-help-search-results').children('div.cs-help-search-result-row:lt(3)').children('h2').find('a');
    }
    firstThreeSearchResultNodes.click(
        function(e) {
            var s = s_gi('acsjp-prod');
            s.linkTrackVars = 'prop10,eVar10';
            s.linkTrackEvents = (omnitureObjJson['page'] >= 1) ? 'event1,event2,event3,event4,event5,event6,event7,event22' : 'event1,event2,event3,event4,event5,event6,event7,event20,event22';
            s.events = (omnitureObjJson['page'] >= 1) ? 'event22' : 'event20,event22';
    ...
    var otherSearchResultNodes;
    if (jQuery('.results-list').length) {
        otherSearchResultNodes = jQuery('.results-list').children('li:gt(2)').find('a');
    } else {
        otherSearchResultNodes = jQuery('.cs-help-search-results').children('div.cs-help-search-result-row:gt(2)').children('h2').find('a');
    }

    otherSearchResultNodes.click(
        function(e) {
            var s = s_gi('acsjp-prod');
            s.linkTrackVars = 'events';
            s.linkTrackEvents = 'event1,event2,event3,event4,event5,event6,event7,event22';
            s.events = 'event22';
    ...
    jQuery("#displayLink a, .csg-hover-box-content a[href*='gp/help/customer/contact-us'], .take-action-sidebar a[href*='gp/help/customer/contact-us']").click(
        function(e) {
            var s = s_gi('acsjp-prod');
            s.linkTrackVars = 'events,prop15';
            s.linkTrackEvents = 'event1,event2,event3,event4,event5,event6,event7';
            s.events = 'event4'; // Clicked the Contact Us button

            var link = jQuery(this);
            s.prop15 = 'CS_HELP_GATEWAY_SS_V2_57525:T3';
            s.list1 = s.prop15;
    ...
    var navTopicNodes;
    if (jQuery('.cs-help-sidebar-module').length) {
        navTopicNodes = jQuery('.cs-help-sidebar-module.topic-sidebar .nav-topics li a');
    } else {
        navTopicNodes = jQuery('#other-areas-content li').add('.nav-level').add('.nav-siblings').add('.nav-children').add('.nav').find('a');
    }
    navTopicNodes.click(
        function(e) {
            var s = s_gi('acsjp-prod');
            s.linkTrackVars =' events,eVar12,prop11,prop15';
            s.linkTrackEvents = 'event1,event2,event3,event4,event5,event6,event7';
            s.events = 'event5'; // Clicked a left-nav link
    ...
    var takeActionNodes;
    if (jQuery('.cs-help-sidebar-module').length) {
          if(jQuery('.cs-help-sidebar-module.take-action-sidebar li a').length) {
              takeActionNodes = jQuery('.cs-help-sidebar-module.take-action-sidebar li a').not('a-button');
          } else {
              takeActionNodes = jQuery('.cs-help-sidebar-module.take-action-sidebar .a-row .a-column a.quick-solution-action');
          }
    } else {
        takeActionNodes = jQuery('.cs-list-jq li a').add('.gray_box div.inner ul.small_list li a').not('.amzn-btn');
    }
    takeActionNodes.add("#help-gateway-category-0 .cs-tools a, a[href*='gp/help/customer/forums']");
    takeActionNodes.click(
        function(e) {
            var s = s_gi('acsjp-prod');
            s.linkTrackVars = 'events,eVar17,prop15';
            s.linkTrackEvents = 'event1,event2,event3,event4,event5,event6,event7';
            s.events = 'event7'; // Clicked a right hand link
    ...
    jQuery('#search-help').add('#search-help-bottom').submit(
        function () {
            var input_value = this.help_keywords.value;
            var s = s_gi('acsjp-prod');
            s.linkTrackVars = 'events,eVar47,prop46';
            s.linkTrackEvents = 'event1,event2,event3,event4,event5,event6,event7,event27';
            s.events = "event27";
            s.eVar47 = input_value;
            s.prop46 = input_value;

            s.tl(this,'o', input_value);

        }
    );

    P.when('wcs-help-faceted-update', 'ready').execute('help-facet-omniture', function() {
        jQuery('.cs-help-search-facets li a').click(
            function (e) {
                var s = s_gi('acsjp-prod');
                s.linkTrackVars = 'events,eVar48,eVar49,eVar50';
                s.linkTrackEvents = 'event1,event2,event3,event4,event5,event6,event7,event28';
                s.events = 'event28';

                var link = jQuery(this);
                var facetName = link.closest('fieldset').find('legend').text();
                var facetValue = link.text();
                s.eVar48 = '' + '|' + facetName + '|' + facetValue;
                s.eVar49 = facetName;
                s.eVar50 = facetValue;
    ...
    var answerBoxLinks = jQuery(".answer-box a").filter(function() {
                                return jQuery(this).attr('href');
                            });
    answerBoxLinks.click(
        function(e) {
            var s = s_gi('acsjp-prod');
            s.linkTrackVars = 'events,eVar9,eVar10,prop10,list1';
            s.linkTrackEvents = 'event1,event2,event3,event4,event5,event6,event7,event13';
            s.events = 'event13';
            s.prop10 = '';
            s.eVar10 = '';
            s.list1 = 'CS_HELP_GATEWAY_SS_V2_57525:T3';
...
P.when('cs-retail-help-omniture','jQuery', 'ready').execute('cs-retail-help-omniture-events', function(helpOmniture, jQuery) {
    // TODO when we're done migrating, move the event function inside of here and replace s_gi with helpOmniture
    window.s_gi = helpOmniture;
    csHelpOmniture.event(0,
        jQuery);
});
   <!--
      /* Ensure a separate start and end tag via a meaningless comment. */
   //-->
</script>

<noscript>
   <img alt="" border="0" height="1" src="https://amazoncustomerservice.d2.sc.omtrdc.net/b/ss/acsjp-prod/1/H.25.2--NS/0" width="1"/>
</noscript>
...
<div aria-live="polite" data-a-expander-name="alert_expander" class="a-row a-expander-container a-spacing-mini a-expander-extend-container">
    <ul id="help-alerts" class="a-unordered-list a-nostyle a-vertical a-spacing-none">
    </ul>
    <div id="alert_expander_content" class="a-section">
        <div aria-expanded="false" class="a-expander-content a-expander-extend-content" style="display:none">
        </div> <!-- expander_content -->
        <div class="a-row">
            <div class="a-section a-padding-mini">
                 <a href="javascript:void(0)" data-action="a-expander-toggle" class="a-expander-header a-declarative a-expander-extend-header" data-a-expander-toggle="{&quot;allowLinkDefault&quot;:true, &quot;expand_prompt&quot;:&quot;すべてのお知らせを見る（他alert-count 件）&quot;, &quot;collapse_prompt&quot;:&quot;隠す&quot;}"><i class="a-icon a-icon-extender-expand"></i><span class="a-expander-prompt">すべてのお知らせを見る（他alert-count 件）
                 </span></a>
            </div>
        </div>  <!-- grid_row -->
    </div> <!-- alert_expander_content -->
</div> <!-- expander -->
</script>

<script id="alertRowTemplate" type="text/template">
    <li class="a-spacing-top-small"><span class="a-list-item">
       <div class="a-box a-alert a-alert-warning a-spacing-top-micro"><div class="a-box-inner a-alert-container"><i class="a-icon a-icon-alert"></i><div class="a-alert-content"></div></div></div>
    </span></li>
</script>

<script id="alertRowExpander" type="text/template">
    <ul id="help-alerts-expanded" class="a-unordered-list a-nostyle a-vertical">
    </ul>
</script>

    
<script id="spotLightTemplate" type="text/template">
     <div id="csg-search-cu" class="a-section a-spacing-large">
     </div>
</script>
<script id="spotLightLineImage" type="text/template">
     <img src="https://images-fe.ssl-images-amazon.com/images/G/09/x-locale/cs/help/images/gateway/u18_line._CB321089116_.png" >
</script>
...
<area shape="rect" coords="0,0,500,500" href="/gp/dmusic/promotions/AmazonMusicUnlimited/ref=nav_shopall_dmm_gw_fo_AM418_99_1115?pf_rd_p=88175488-1c45-4547-9b56-98181f275518&amp;pf_rd_s=nav-sa-mp3&amp;pf_rd_t=4201&amp;pf_rd_i=navbar-4201&amp;pf_rd_m=A1VC38T7YXB528&amp;pf_rd_r=GS11C6Q0922HC0M7BYN7" alt=" Amazon Music Unlimited - 3か月99円で音楽聴き放題">
...
<area shape="rect" coords="0,0,480,439" href="/b/ref=nav_shopall_nav_flyout_apps_hollywood?_encoding=UTF8&amp;node=6124554051&amp;pf_rd_p=27d8392e-b7b7-44c3-9039-ed30eaa03833&amp;pf_rd_s=nav-sa-android&amp;pf_rd_t=4201&amp;pf_rd_i=navbar-4201&amp;pf_rd_m=A1VC38T7YXB528&amp;pf_rd_r=GS11C6Q0922HC0M7BYN7" alt="Androidスマートフォン特集">
...
<area shape="polygon" coords="2,478,1,256,225,231,324,155,379,143,433,126,498,122,500,479" href="/dp/B0794PLC5W/ref=nav_shopall_nav_flyout_2Pack?pf_rd_p=f6d679c9-dc6d-4d2b-bd5d-3b4e03b82bf6&amp;pf_rd_s=nav-sa-fire-tablet&amp;pf_rd_t=4201&amp;pf_rd_i=navbar-4201&amp;pf_rd_m=A1VC38T7YXB528&amp;pf_rd_r=GS11C6Q0922HC0M7BYN7" alt="【新登場】Fire HD 8">
...
<area shape="polygon" coords="2,478,1,256,225,231,324,155,379,143,433,126,498,122,500,479" href="/dp/B079QRQTCR/ref=nav_shopall_nav_flyout_firetvstick4K?pf_rd_p=99e8f24b-34f4-474c-b34e-a87534df9891&amp;pf_rd_s=nav-sa-fire-tv&amp;pf_rd_t=4201&amp;pf_rd_i=navbar-4201&amp;pf_rd_m=A1VC38T7YXB528&amp;pf_rd_r=GS11C6Q0922HC0M7BYN7" alt="Fire TV">
...
<area shape="poly" coords="2,478,1,256,225,231,324,155,379,143,433,126,498,122,500,479" href="/dp/B07HCSQ48P/ref=nav_shopall_nav_flyout_kindle_moolaunch?pf_rd_p=58204f20-251b-476d-a3f7-23dabaec7083&amp;pf_rd_s=nav-sa-kindle-reader&amp;pf_rd_t=4201&amp;pf_rd_i=navbar-4201&amp;pf_rd_m=A1VC38T7YXB528&amp;pf_rd_r=GS11C6Q0922HC0M7BYN7" alt="Kindle">
...
<area shape="rect" coords="0,0,500,455" href="/b/ref=nav_shopall_nav_flyout_amazon_adbl?_encoding=UTF8&amp;node=3479195051&amp;pf_rd_p=af09947c-4930-4cea-843d-798589233a2e&amp;pf_rd_s=nav-sa-books-comics-magazines&amp;pf_rd_t=4201&amp;pf_rd_i=navbar-4201&amp;pf_rd_m=A1VC38T7YXB528&amp;pf_rd_r=GS11C6Q0922HC0M7BYN7" alt="本を聴くオーディブル">
...
<area shape="rect" coords="0,0,500,500" href="/b/ref=nav_shopall_?_encoding=UTF8&amp;node=6187387051&amp;pf_rd_p=83561074-5e37-44ac-89f9-a6d30da8cc2a&amp;pf_rd_s=nav-sa-dvd-music-games&amp;pf_rd_t=4201&amp;pf_rd_i=navbar-4201&amp;pf_rd_m=A1VC38T7YXB528&amp;pf_rd_r=GS11C6Q0922HC0M7BYN7" alt="nav_flyout_videogame">
...
<area shape="rect" coords="0,0,519,522" href="/b/ref=nav_shopall_HOME_Autumn_kitchengoods?ie=UTF8&amp;node=5349248051&amp;pf_rd_p=1d0a5814-b941-4034-b4ef-434a3df9afea&amp;pf_rd_s=nav-sa-home-kitchen-pets&amp;pf_rd_t=4201&amp;pf_rd_i=navbar-4201&amp;pf_rd_m=A1VC38T7YXB528&amp;pf_rd_r=GS11C6Q0922HC0M7BYN7" alt="秋の味覚を楽しむキッチン用品">
...
<area shape="rect" coords="0,0,519,512" href="/b/ref=nav_shopall_nav_flyout_satofull?ie=UTF8&amp;node=6162974051&amp;pf_rd_p=b416649f-9b42-4b82-8612-74b6f4b75375&amp;pf_rd_s=nav-sa-food-beverage&amp;pf_rd_t=4201&amp;pf_rd_i=navbar-4201&amp;pf_rd_m=A1VC38T7YXB528&amp;pf_rd_r=GS11C6Q0922HC0M7BYN7" alt="「さとふる」ふるさと納税でAmazonギフト券プレゼントキャンペーン">
...
<area shape="rect" coords="0,0,519,515" href="/b/ref=nav_shopall_nav_flyout_hpc?ie=UTF8&amp;node=6157750051&amp;pf_rd_p=40c0f27d-c3bd-44b4-aae6-01c89291a31e&amp;pf_rd_s=nav-sa-health-beauty&amp;pf_rd_t=4201&amp;pf_rd_i=navbar-4201&amp;pf_rd_m=A1VC38T7YXB528&amp;pf_rd_r=GS11C6Q0922HC0M7BYN7" alt="ドラッグストア クーポン祭り">
...
<area shape="rect" coords="0,0,493,448" href="/baby-reg/homepage/ref=nav_shopall_nav_flyout_br?pf_rd_p=2b2606c6-1fe6-4602-8001-cf7d99ad4411&amp;pf_rd_s=nav-sa-baby-toys-hobby&amp;pf_rd_t=4201&amp;pf_rd_i=navbar-4201&amp;pf_rd_m=A1VC38T7YXB528&amp;pf_rd_r=GS11C6Q0922HC0M7BYN7" alt="Amazonベビーレジストリ">
...
<area shape="rect" coords="0,0,517,524" href="/b/ref=nav_shopall_nav_SL_FLYFX?_encoding=UTF8&amp;node=4715510051&amp;pf_rd_p=bf2659a2-4b47-4454-a934-c2dce72f0b64&amp;pf_rd_s=nav-sa-fashion-bags-watches&amp;pf_rd_t=4201&amp;pf_rd_i=navbar-4201&amp;pf_rd_m=A1VC38T7YXB528&amp;pf_rd_r=GS11C6Q0922HC0M7BYN7" alt="AT TOKYO2019">
...
<area shape="rect" coords="0,0,519,512" href="/b/ref=nav_shopall_nav_flyout_biss?ie=UTF8&amp;node=3550310051&amp;pf_rd_p=4354b493-1722-45f6-bc63-b73d4fa1bda0&amp;pf_rd_s=nav-sa-diy-autoparts&amp;pf_rd_t=4201&amp;pf_rd_i=navbar-4201&amp;pf_rd_m=A1VC38T7YXB528&amp;pf_rd_r=GS11C6Q0922HC0M7BYN7" alt="nav_flyout_biss">
...
<area shape="rect" coords="0,0,499,492" href="/b/ref=nav_shopall_nav_flyout_jpcbcc_ap?_encoding=UTF8&amp;node=3036192051&amp;plattr=JPCBCCAP15FLY&amp;pf_rd_p=4a128774-9f36-44b2-bae8-13c13ed7b644&amp;pf_rd_s=nav-sa-credit-and-points&amp;pf_rd_t=4201&amp;pf_rd_i=navbar-4201&amp;pf_rd_m=A1VC38T7YXB528&amp;pf_rd_r=GS11C6Q0922HC0M7BYN7" alt="Amazon MasterCard">
  ...
  <a href="/gp/customer-preferences/select-language/ref=topnav_lang?preferencesReturnUrl=%2Fgp%2Fhelp%2Fcustomer%2Fdisplay.html%3Fie%3DUTF8%26nodeId%3D642938" id="icp-nav-flyout" class="nav-a nav-a-2 icp-link-style-2">
...
window.$Nav && $Nav.declare('config.pageType', 'GPHelp');
window.$Nav && $Nav.declare('config.subPageType', 'Gateway');
...
window.$Nav && $Nav.declare('config.requestId', 'GS11C6Q0922HC0M7BYN7');
...
window.$Nav && $Nav.declare('config.dynamicMenuArgs',
  {"rid":"GS11C6Q0922HC0M7BYN7","isFullWidthPrime":0,"isPrime":0,"dynamicRequest":1,"weblabs":"","isFreshRegionAndCustomer":"","primeMenuWidth":310});
...
window.$Nav && $Nav.declare('config.searchBackState',
  ...
  var opts = {
    ...
    , filterAliases: []
    , pageType: "GPHelp"
    , requestId: "GS11C6Q0922HC0M7BYN7"
    , sessionId: "356-1298069-6592723"
    , language: "ja_JP"
    , customerId: ""
    , b2b: 0
    , fresh: 0
    , biaWidgetUrl: "/gp/yourstore?ie=UTF8&edit=1&p=Qo20LYmmUyScxjgRbmxQ0EGs%2FS9K4JvP%2BZ2QojTND3entBrGuIhB2OlKqDHMw1nVtng3xKs3iVakQdvntVhhovEm%2Fcz6wVuo&ref=nb_sb_ss_bia_acct"
    , isDdInT3: 0
    , isDdInT1: 0
    , isJpOrCn: 1
    , isUseAuiIss: 1
...
if (window.P && typeof window.P.declare === "function" && typeof window.P.now === "function") {
  ...
  window.P.now('packardGlowStoreName').execute(function(storeName) {
    if (!storeName) {
      window.P.declare('packardGlowStoreName', 'help');
    }
  });
...
<div aria-live="polite" data-a-expander-name="alert_expander" class="a-row a-expander-container a-spacing-mini a-expander-extend-container ss-landing-container a-spacing-top-large">
    <ul id="help-alerts" class="a-unordered-list a-nostyle a-vertical a-spacing-none">
    <li class="a-spacing-top-small"><span class="a-list-item">
       <div class="a-box a-alert a-alert-warning a-spacing-top-micro"><div class="a-box-inner a-alert-container"><i class="a-icon a-icon-alert"></i><div class="a-alert-content">Amazon.co.jpを装い、お客様の情報を不正に取得する詐欺が発生しています。不審なEメールやSMSなどが届いた場合、絶対に添付ファイルやリンクを開かず、記載された電話番号には連絡しないでください。詳しくは、<a href="https://www.amazon.co.jp/gp/help/customer/display.html/ref=hp_gt_aiwem_al_pc?nodeId=201909120" target="_blank">こちら</a>をご覧ください。 </div></div></div>
    </span></li></ul>
    <div id="alert_expander_content" class="a-section">
        <div aria-expanded="false" class="a-expander-content a-expander-extend-content" style="display:none">
        </div> <!-- expander_content -->
        <div class="a-row">
            <div class="a-section a-padding-mini">
                 <a href="javascript:void(0)" data-action="a-expander-toggle" class="a-expander-header a-declarative a-expander-extend-header" data-a-expander-toggle="{&quot;allowLinkDefault&quot;:true, &quot;expand_prompt&quot;:&quot;すべてのお知らせを見る（他alert-count 件）&quot;, &quot;collapse_prompt&quot;:&quot;隠す&quot;}" style="display: none;"><i class="a-icon a-icon-extender-expand"></i><span class="a-expander-prompt">すべてのお知らせを見る（他alert-count 件）
                 </span></a>
            </div>
        </div>  <!-- grid_row -->
    </div> <!-- alert_expander_content -->
</div><div class="a-section a-spacing-extra-large a-spacing-top-extra-large ss-landing-container">
    <h1>
        ご希望の操作を選択してください
    </h1>
 </div>
    ...
    <div class="a-divider a-divider-section a-spacing-base"><div class="a-divider-inner"></div></div>
    <div class="a-row">
        <div class="a-column a-span12 ss-gradient-bg">
            <div class="a-section a-spacing-large ss-landing-container-wide">


                        <div class="a-row a-spacing-large a-spacing-top-micro">
                     <div class="a-column a-span4">

                         <div class="a-row a-grid-vertical-align a-grid-top">
                             
   
    <div class="a-column a-span4 a-text-center">
        <a class="a-link-normal" href="/gp/css/order-history/ref=hp_ss_v3_yo_t4">
            <img alt="配送状況や注文の確認" src="https://images-fe.ssl-images-amazon.com/images/G/09/x-locale/cs/help/images/gateway/Box-t3._CB310987744_.png">
        </a>
    </div><!-- end column -->
    <div class="a-column a-span8 a-span-last">
        <a class="a-size-medium a-link-normal a-text-bold" href="/gp/css/order-history/ref=hp_ss_v3_yo_t4">
            配送状況や注文の確認
        </a>
        <ul class="a-unordered-list a-vertical a-spacing-top-mini">
            <li class="a-spacing-none"><span class="a-list-item a-size-base">
配送状況の確認            </span></li>
            <li class="a-spacing-none"><span class="a-list-item a-size-base">
領収書の表示            </span></li>
        </ul><!-- end list -->
    ...
    <div class="a-column a-span4 a-text-center">
        <a class="a-link-normal" href="/gp/orc/returns/homepage.html/ref=orc_surl_ret_hp">
            <img alt="返品・交換" src="https://images-fe.ssl-images-amazon.com/images/G/09/x-locale/cs/help/images/gateway/returns-box-blue._CB287136091_.png">
        </a>
    </div><!-- end column -->
    <div class="a-column a-span8 a-span-last">
        <a class="a-size-medium a-link-normal a-text-bold" href="/gp/orc/returns/homepage.html/ref=orc_surl_ret_hp">
            返品・交換
        </a>
        <ul class="a-unordered-list a-vertical a-spacing-top-mini">
            <li class="a-spacing-none"><span class="a-list-item a-size-base">
...
返品/交換可否や返送方法の確認            </span></li>
    ...
    <div class="a-column a-span4 a-text-center">
        <a class="a-link-normal" href="/gp/help/customer/display.html/ref=hp_ss_v3_ds_t4?ie=UTF8&amp;nodeId=200127470">
            <img alt="デバイスサポート" src="https://images-fe.ssl-images-amazon.com/images/G/09/x-locale/cs/help/images/gateway/family_device._CB500111552_.png">
        </a>
    </div><!-- end column -->
    <div class="a-column a-span8 a-span-last">
        <a class="a-size-medium a-link-normal a-text-bold" href="/gp/help/customer/display.html/ref=hp_ss_v3_ds_t4?ie=UTF8&amp;nodeId=200127470">
            デバイスサポート
        </a>
        <ul class="a-unordered-list a-vertical a-spacing-top-mini">
            <li class="a-spacing-none"><span class="a-list-item a-size-base">
...
端末の問題解決            </span></li>
    ...
    <div class="a-column a-span4 a-text-center">
        <a class="a-link-normal" href="/gp/primecentral/ref=hp_ss_v3_mp_t4">
            <img alt="プライム会員情報の管理" src="https://images-fe.ssl-images-amazon.com/images/G/09/x-locale/cs/help/images/gateway/Prime-JP._CB506132614_.png">
        </a>
    </div><!-- end column -->
    <div class="a-column a-span8 a-span-last">
        <a class="a-size-medium a-link-normal a-text-bold" href="/gp/primecentral/ref=hp_ss_v3_mp_t4">
            プライム会員情報の管理
        </a>
        <ul class="a-unordered-list a-vertical a-spacing-top-mini">
            <li class="a-spacing-none"><span class="a-list-item a-size-base">
...
会員登録のキャンセル            </span></li>
    ...
    <div class="a-column a-span4 a-text-center">
        <a class="a-link-normal" href="/gp/css/account/cards/view.html/ref=hp_ss_v3_ps_t4">
            <img alt="支払い方法、Amazonギフト券" src="https://images-fe.ssl-images-amazon.com/images/G/09/x-locale/cs/help/images/gateway/Payments_clear-bg-t3._CB522136234_.png">
        </a>
    </div><!-- end column -->
    <div class="a-column a-span8 a-span-last">
        <a class="a-size-medium a-link-normal a-text-bold" href="/gp/css/account/cards/view.html/ref=hp_ss_v3_ps_t4">
            支払い方法、Amazonギフト券
        </a>
        <ul class="a-unordered-list a-vertical a-spacing-top-mini">
            <li class="a-spacing-none"><span class="a-list-item a-size-base">
お支払い方法の追加と編集            </span></li>
            <li class="a-spacing-none"><span class="a-list-item a-size-base">
ギフト券残高の確認            </span></li>
        </ul><!-- end list -->
    </div><!-- end column -->
    ...
    <div class="a-column a-span4 a-text-center">
        <a class="a-link-normal" href="/ap/cnep/ref=hp_ss_v3_as_t4?_encoding=UTF8&amp;openid.assoc_handle=jpflex&amp;openid.claimed_id=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0%2Fidentifier_select&amp;openid.identity=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0%2Fidentifier_select&amp;openid.mode=checkid_setup&amp;openid.ns=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0&amp;openid.ns.pape=http%3A%2F%2Fspecs.openid.net%2Fextensions%2Fpape%2F1.0&amp;openid.pape.max_auth_age=0&amp;openid.return_to=https%3A%2F%2Fwww.amazon.jp%2Fgp%2Fcss%2Fhomepage.html%3F%20%20ie%3DUTF8%26ref_%3Dya_cnep">
            <img alt="アカウント設定" src="https://images-fe.ssl-images-amazon.com/images/G/09/x-locale/cs/help/images/gateway/IN-your-account._CB287136091_.png">
        </a>
    </div><!-- end column -->
    <div class="a-column a-span8 a-span-last">
        <a class="a-size-medium a-link-normal a-text-bold" href="/ap/cnep/ref=hp_ss_v3_as_t4?_encoding=UTF8&amp;openid.assoc_handle=jpflex&amp;openid.claimed_id=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0%2Fidentifier_select&amp;openid.identity=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0%2Fidentifier_select&amp;openid.mode=checkid_setup&amp;openid.ns=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0&amp;openid.ns.pape=http%3A%2F%2Fspecs.openid.net%2Fextensions%2Fpape%2F1.0&amp;openid.pape.max_auth_age=0&amp;openid.return_to=https%3A%2F%2Fwww.amazon.jp%2Fgp%2Fcss%2Fhomepage.html%3F%20%20ie%3DUTF8%26ref_%3Dya_cnep">
            アカウント設定
        </a>
        <ul class="a-unordered-list a-vertical a-spacing-top-mini">
            <li class="a-spacing-none"><span class="a-list-item a-size-base">
Eメールアドレスやパスワードの変更            </span></li>
            <li class="a-spacing-none"><span class="a-list-item a-size-base">
アカウント名の変更            </span></li>
        </ul><!-- end list -->
    </div><!-- end column -->
    ...
    <div class="a-section a-spacing-extra-large a-spacing-top-extra-large ss-landing-container">
        ...
        <div id="csg-search-cu" class="a-section a-spacing-small">
        <div class="a-row">
	    <form id="search-help" name="search-help" method="get" action="/gp/help/customer/display.html/ref=hp_search_rd_gw?ie=UTF8&amp;nodeId=">
	        <input type="hidden" name="__mk_ja_JP" value="カタカナ">
	        <div class="a-column a-span10">
	            <div class="a-row">
	                <div class="a-search a-span12"><i class="a-icon a-icon-search"></i><input type="search" maxlength="100" id="helpsearch" autocomplete="off" placeholder="ヘルプの検索" name="help_keywords" class="a-input-text a-span12"></div>
	                </div>
	                <div class="a-row">
	            ...
	            <div class="a-column a-span2 a-span-last">
	                <span id="helpSearchSubmit" class="a-button a-button-span12 a-button-base a-button-dark"><span class="a-button-inner"><input class="a-button-input" type="submit" aria-labelledby="helpSearchSubmit-announce"><span id="helpSearchSubmit-announce" class="a-button-text" aria-hidden="true">検索
	                </span></span></span>
	            </div>
	            ...
	            <input type="hidden" name="kwHidden" value="true" id="searchPlaceholder">
                    ...
                    <input type="hidden" name="locale" value="jp_JP">
	        </form>
	    </div>
	</div>
...
<div class="help-content csg" style="display: block;"><div class="csg-inner">

 
<div class="csg-header a-row a-spacing-small"><div class="a-span12 a-column a-spacing-top-small"><h1>
    トピックから探す
</h1></div></div> <!-- expander --><div class="csg-box" id="csg-support-topics"><div class="csg-box-inner"><div class="csg-hover-box clearfix"><div class="csg-hover-box-categories"><ul id="category-section" class="a-nostyle a-list-link"><li class="csg-category"><a class="active" tabindex="0" rel="#help-gateway-category-0">よくある質問</a><div style="display: block;" class="nav-sprite arrow"><i class="a-icon a-icon-supplemental"></i></div></li><li class="csg-category"><a tabindex="-1" rel="#help-gateway-category-1">
配送料・配送オプション
</a><div class="nav-sprite arrow"><i class="a-icon a-icon-supplemental"></i></div></li><li class="csg-category"><a tabindex="-1" rel="#help-gateway-category-2">
返品・返金
</a><div class="nav-sprite arrow"><i class="a-icon a-icon-supplemental"></i></div></li><li class="csg-category"><a tabindex="-1" rel="#help-gateway-category-3">
支払い方法
</a><div class="nav-sprite arrow"><i class="a-icon a-icon-supplemental"></i></div></li><li class="csg-category"><a tabindex="-1" rel="#help-gateway-category-4"> 
注文の変更・キャンセル
</a><div class="nav-sprite arrow"><i class="a-icon a-icon-supplemental"></i></div></li><li class="csg-category"><a tabindex="-1" rel="#help-gateway-category-5">
登録情報の管理
</a><div class="nav-sprite arrow"><i class="a-icon a-icon-supplemental"></i></div></li><li class="csg-category"><a tabindex="-1" rel="#help-gateway-category-6">
Amazonデバイス
</a><div class="nav-sprite arrow"><i class="a-icon a-icon-supplemental"></i></div></li><li class="csg-category"><a tabindex="-1" rel="#help-gateway-category-7">
デジタルサービス
</a><div class="nav-sprite arrow"><i class="a-icon a-icon-supplemental"></i></div></li><li class="csg-category"><a tabindex="-1" rel="#help-gateway-category-8">その他</a><div class="nav-sprite arrow"><i class="a-icon a-icon-supplemental"></i></div></li><li class="csg-category"><a tabindex="-1" rel="#help-gateway-category-9">問題が解決しない場合は</a><div class="nav-sprite arrow"><i class="a-icon a-icon-supplemental"></i></div></li></ul></div><div class="csg-hover-box-content active" id="help-gateway-category-0"><div class="a-row"><img class="csg-hb-promo" src="https://images-na.ssl-images-amazon.com/images/G/01/support_images/GUID-DC1B73E1-763B-4FD4-A83A-EAB1EF6AAFEC_ja-JP.png"><div class="cat-links-container" style="width: 500px;"><div class="a-column a-span6"><ul class="category-list a-nostyle a-list-link "><li><h3 class="a-spacing-small">
    お困りですか？
</h3></li> 
<li>
<a class="same_window cs-override-recommended" href="https://www.amazon.co.jp/gp/help/customer/display.html/ref=hp_gt_faq_rewms?nodeId=201910530" target="_self">•　最新の配送状況を確認したい</a>
</li>

<li>
<a class="same_window cs-override-recommended" href="https://www.amazon.co.jp/gp/help/customer/display.html/ref=hp_gt_rectps?nodeId=201889690" target="_self">•　出品者販売品に関する問い合わせ</a>
</li>

<li>
<a class="same_window cs-override-recommended" href="https://www.amazon.co.jp/gp/help/customer/display.html/ref=gms_rr?nodeId=201824330" target="_self">•　返品・交換したい</a>
</li>

<li>
<a class="same_window cs-override-recommended" href="https://www.amazon.co.jp/gp/help/customer/display.html/ref=hp_gt_recpm?nodeId=201910380" target="_self">•　Amazonプライムのキャンセル方法</a>
</li>

<li>
<a class="same_window cs-override-recommended" href="https://www.amazon.co.jp/gp/help/customer/display.html/ref=hp_gt_reapi?nodeId=202003100" target="_self">•　コンビニのお支払い番号について</a>
</li>

<li>
<a class="same_window cs-override-recommended" href="https://www.amazon.co.jp/gp/help/customer/display.html/ref=hp_gt_rece?nodeId=201894740" target="_self">•　領収書の発行について</a>
</li>
 
<li>
<a href="https://www.amazon.co.jp/gp/help/customer/display.html/ref=hp_gw_recyas?nodeId=201945280" target="_blank">•　アカウント情報を変更する</a>
</li>
 
		  
</ul></div><div class="a-column a-span5 a-span-last  cs-tools"><img alt="" class="csg-cat-sep" src="https://images-na.ssl-images-amazon.com/images/G/01/x-locale/cs/help/images/gateway/line.png"><ul class="category-list a-nostyle a-list-link a-spacing-top-mini"><li><h3 class="a-spacing-small">お手続きはこちらから</h3></li> 
<li> 
<a class="same_window" href="/gp/css/order-history/ref=hp_gt_qstyp" target="_self">注文内容の確認・変更・キャンセル </a> 
</li>
 
<li> 
<a class="same_window" href="/gp/css/account/cards/view.html/ref=hp_gt_qsepm" target="_self">支払い方法の変更または削除</a> 
</li>
 
<li> 
<a class="same_window" href="https://www.amazon.co.jp/ap/cnep/ref=hp_gt_qscynep?openid.assoc_handle=jpflex" target="_self"> 名前、Eメールアドレス、パスワードの変更</a> 
</li>
 
		  
</ul></div></div></div></div><div class="csg-hover-box-content" id="help-gateway-category-1"><div class="a-row"><img class="csg-hb-promo" src="https://images-na.ssl-images-amazon.com/images/G/01/support_images/GUID-14B0880C-FE88-49DC-8E4A-800AC4CF5E90_ja-JP.png"><div class="cat-links-container" style="width: 500px;"><div class="a-column"><ul class="category-list a-nostyle a-list-link "><li><h3 class="a-spacing-small">配送料・配送オプション</h3></li> 
<li>
<a class="same_window" href="https://www.amazon.co.jp/gp/help/customer/display.html/ref=hp_gt_spsr?nodeId=201911210" target="_self">配送料について</a> 
</li>
 
<li>
<a class="same_window" href="https://www.amazon.co.jp/gp/help/customer/display.html/ref=hp_gt_spsso?nodeId=201910150" target="_self">配送オプション</a> 
</li>
 
<li> 
<a class="same_window" href="https://www.amazon.co.jp/gp/help/customer/display.html/ref=hp_gt_myaam?nodeId=201910250" target="_self">Amazonプライム</a> 
</li>

<li class="csg_more"><span class="a-color-state"> › </span>
<a class="same_window" href="https://www.amazon.co.jp/gp/help/customer/display.html/ref=hp_gt_sp?nodeId=201910060" target="_self">もっと見る</a> 
</li>
 
		  
</ul></div></div></div></div><div class="csg-hover-box-content" id="help-gateway-category-2"><div class="a-row"><img class="csg-hb-promo" src="https://images-na.ssl-images-amazon.com/images/G/01/support_images/GUID-F49D70BD-CA9B-4D08-9221-D704F6AFCC6F_ja-JP.png"><div class="cat-links-container" style="width: 500px;"><div class="a-column"><ul class="category-list a-nostyle a-list-link "><li><h3 class="a-spacing-small">返品・返金</h3></li>  
		   
<li>
<a class="same_window" href="https://www.amazon.co.jp/gp/help/customer/display.html/ref=hp_gt_rrcant?nodeId=202063080" target="_self">返品・交換の条件</a> 
</li>

<li>
<a class="same_window" href="https://www.amazon.co.jp/gp/help/customer/display.html/ref=hp_gt_rrriyo?nodeId=201824330" target="_self">返品・交換の手続きをする</a> 
</li>

<li>
<a class="same_window" href="https://www.amazon.co.jp/gp/help/customer/display.html/ref=hp_gt_rrref?nodeId=201819300" target="_self">返金について</a> 
</li>
 
<li>
<a class="same_window" href="https://www.amazon.co.jp/gp/help/customer/display.html/ref=hp_gt_rrcrs?nodeId=201819290" target="_self">返金状況を確認する</a> 
</li>

<li class="csg_more"><span class="a-color-state"> › </span>
<a class="same_window" href="https://www.amazon.co.jp/gp/help/customer/display.html/ref=hp_gt_rr?nodeId=201819090" target="_self">もっと見る</a> 
</li>
 
		  
</ul></div></div></div></div><div class="csg-hover-box-content" id="help-gateway-category-3"><div class="a-row"><img class="csg-hb-promo" src="https://images-na.ssl-images-amazon.com/images/G/01/support_images/GUID-BDD77CC5-2374-48F7-89F2-18E8D51194D4_ja-JP.png"><div class="cat-links-container" style="width: 500px;"><div class="a-column"><ul class="category-list a-nostyle a-list-link "><li><h3 class="a-spacing-small">支払い方法</h3></li> 
<li>
<a class="same_window" href="https://www.amazon.co.jp/gp/help/customer/display.html/ref=hp_gt_pmcvs?nodeId=202107340" target="_self">コンビニ・ATM・ネットバンキング・電子マネー払いについて</a> 
</li>
 
<li>
<a class="same_window" href="https://www.amazon.co.jp/gp/help/customer/display.html/ref=hp_gt_pmpay?nodeId=202003100" target="_self">お支払い番号について</a> 
</li>
 
<li>
<a class="same_window" href="https://www.amazon.co.jp/gp/help/customer/display.html/ref=hp_gt_pmucc?nodeId=201895580" target="_self">不明なクレジットカード請求について</a> 
</li>

<li class="csg_more"><span class="a-color-state"> › </span>
<a class="same_window" href="https://www.amazon.co.jp/gp/help/customer/display.html/ref=hp_gt_pm?nodeId=201894900" target="_self">もっと見る</a> 
</li>
 
		  
</ul></div></div></div></div><div class="csg-hover-box-content" id="help-gateway-category-4"><div class="a-row"><img class="csg-hb-promo" src="https://images-na.ssl-images-amazon.com/images/G/01/support_images/GUID-D2D25277-9C3E-44CD-9318-37A084D06D95_ja-JP.png"><div class="cat-links-container" style="width: 500px;"><div class="a-column"><ul class="category-list a-nostyle a-list-link "><li><h3 class="a-spacing-small">注文の変更・キャンセル</h3></li> 
<li>
<a class="same_window" href="https://www.amazon.co.jp/gp/help/customer/display.html/ref=hp_gt_myocio?nodeId=201976060" target="_self">注文のキャンセル</a> 
</li>
 
<li>
<a class="same_window" href="https://www.amazon.co.jp/gp/help/customer/display.html/ref=hp_gt_myocyo?nodeId=201945410" target="_self">注文内容の確認・変更</a> 
</li>

<li>
<a class="same_window" href="https://www.amazon.co.jp/gp/help/customer/display.html/ref=hp_gt_myoctps?nodeId=201889690" target="_self">出品者に問い合わせる</a> 
</li>
 
<li class="csg_more"><span class="a-color-state"> › </span>
<a class="same_window" href="https://www.amazon.co.jp/gp/help/customer/display.html/ref=hp_gt_myo?nodeId=201945500" target="_self">もっと見る</a> 
</li>
 
		  
</ul></div></div></div></div><div class="csg-hover-box-content" id="help-gateway-category-5"><div class="a-row"><img class="csg-hb-promo" src="https://images-na.ssl-images-amazon.com/images/G/01/support_images/GUID-88BDB20E-9A1C-4DBF-996F-C6F0CF1BE423_ja-JP.png"><div class="cat-links-container" style="width: 500px;"><div class="a-column"><ul class="category-list a-nostyle a-list-link "><li><h3 class="a-spacing-small">登録情報の管理</h3></li> 
<li> 
<a class="same_window" href="https://www.amazon.co.jp/gp/help/customer/display.html/ref=hp_gt_myacas?nodeId=201945280" target="_self"> アカウント設定の変更</a> 
</li>
 
<li> 
<a class="same_window cs-override-recommended" href="https://www.amazon.co.jp/gp/help/customer/display.html/ref=hp_gt_myacya?nodeId=201945400" target="_self">アカウントを閉じる</a> 
</li>

<li> 
<a class="same_window cs-override-recommended" href="https://www.amazon.co.jp/gp/help/customer/display.html/ref=hp_gt_myacsi?nodeId=201945460" target="_self">サインインできない場合</a> 
</li>
 
<li class="csg_more"><span class="a-color-state"> › </span> 
<a class="same_window" href="https://www.amazon.co.jp/gp/help/customer/display.html/ref=hp_gt_mya?nodeId=201945240" target="_self">もっと見る</a> 
</li>
 
		  
</ul></div></div></div></div><div class="csg-hover-box-content" id="help-gateway-category-6"><div class="a-row"><img class="csg-hb-promo" src="https://images-na.ssl-images-amazon.com/images/G/01/support_images/GUID-605677AD-BFFD-48B0-96DA-86D75265267B_ja-JP.png"><img class="csg-hb-promo" src="https://images-na.ssl-images-amazon.com/images/G/01/support_images/GUID-8813E531-8555-46C7-A1CE-066C68F89B63_ja-JP.png" id="help-gateway-menu-sub-img-0" style="display: none;"><img class="csg-hb-promo" src="https://images-na.ssl-images-amazon.com/images/G/01/support_images/GUID-FE8CB275-52C0-42D9-AD60-BCBFFA5769B5_ja-JP.png" id="help-gateway-menu-sub-img-1" style="display: none;"><img class="csg-hb-promo" src="https://images-na.ssl-images-amazon.com/images/G/01/support_images/GUID-1018ACEA-3A51-4C2A-9865-FDC312DEEF5A_ja-JP.png" id="help-gateway-menu-sub-img-2" style="display: none;"><img class="csg-hb-promo" src="https://images-na.ssl-images-amazon.com/images/G/01/support_images/GUID-EDB287D4-E749-496F-9317-DE70F2650F1B_ja-JP.png" id="help-gateway-menu-sub-img-3" style="display: none;"><img class="csg-hb-promo" src="https://images-na.ssl-images-amazon.com/images/G/01/support_images/GUID-09F3F6C3-EB12-49FF-81C5-91F41C5F9396_ja-JP.png" id="help-gateway-menu-sub-img-4" style="display: none;"><div class="cat-links-container" style="width: 500px;"><div class="a-column a-span6"><ul class="category-list a-nostyle a-list-link "><li><h3 class="a-spacing-small">Amazonデバイス</h3></li> 
<li rel="#help-gateway-menu-sub-img-0"> 
<a class="same_window" href="https://www.amazon.co.jp/gp/help/customer/display.html?nodeId=202010090" target="_self">Echo Dot</a></li>
 
<li class="same_window" rel="#help-gateway-menu-sub-img-1">
<a class="same_window" href="https://www.amazon.co.jp/gp/help/customer/display.html?nodeId=202189070" target="_self">Echo Plus</a></li>
 
<li rel="#help-gateway-menu-sub-img-2">
<a class="same_window" href=" /gp/help/customer/display.html/ref=hp_gt_paperw?nodeId=201733150" target="_self"> Kindle Paperwhite（第10世代）</a></li>

<li rel="#help-gateway-menu-sub-img-3">
<a class="same_window" href="https://www.amazon.co.jp/gp/help/customer/display.html?nodeId=GK8EXLB2EK6YHAT2" target="_self">Fire HD 8 （第8世代）</a></li>

<li rel="#help-gateway-menu-sub-img-4"> 
<a class="same_window cs-override-recommended" href="/gp/help/customer/display.html/ref=hp_gt_kind_aftvd?nodeId=201729510" target="_self">Amazon Fire TVシリーズ</a> 
			 </li>

			 
<li class="csg_more"><span class="a-color-state"> › </span> 
<a class="same_window" href="/gp/help/customer/display.html/ref=hp_gt_kin?nodeId=200127470" target="_self"> すべての端末とKindle無料アプリ</a> 
</li>
 
<li class="csg_more"><span class="a-color-state"> › </span>
<a class="same_window" href="https://www.amazon.co.jp/gp/help/customer/display.html?nodeId=200875610" target="_self">コンテンツ・端末の管理</a>
</li>

			 
<li class="csg_more"><span class="a-color-state"> › </span> 
<a class="same_window" href="/gp/help/customer/display.html/ref=hp_gt_dc_kin?ie=UTF8&amp;nodeId=201706240 " target="_self">Kindleコンテンツ/Kindle Unlimited</a>
</li>
 
		  
</ul></div><div class="a-column a-span5 a-span-last  cs-tools"><img alt="" class="csg-cat-sep" src="https://images-na.ssl-images-amazon.com/images/G/01/x-locale/cs/help/images/gateway/line.png"><ul class="category-list a-nostyle a-list-link a-spacing-top-mini"><li><h3 class="a-spacing-small">関連トピック</h3></li> 
<li>
<a class="same_window" href="https://www.amazon.co.jp/gp/help/customer/display.html?nodeId=201952240" target="_self">Alexa ヘルプ</a>
</li>

<li>
<a class="same_window" href="https://www.amazon.co.jp/gp/help/customer/display.html?nodeId=201452330 " target="_self">Amazon Fire TV 端末の設定</a>
</li>

<li>
<a class="same_window" href="https://www.amazon.co.jp/gp/help/customer/display.html?nodeId=201829190" target="_self">Fireタブレットを登録する</a>
</li>
 
<li>
<a class="same_window" href="https://www.amazon.co.jp/gp/help/customer/display.html/?nodeId=201733370 " target="_self">Kindleを登録する</a>
</li>
 
<li>
<a class="same_window" href="https://www.amazon.co.jp/gp/help/customer/display.html?nodeId=201964260" target="_self">Amazonデバイスをギフトとして贈る</a>
</li>
 
		  
</ul></div></div></div></div><div class="csg-hover-box-content" id="help-gateway-category-7"><div class="a-row"><img class="csg-hb-promo" src="https://images-na.ssl-images-amazon.com/images/G/01/support_images/GUID-32636442-A52D-442D-B06D-1ED5905B5FD2_ja-JP.png"><div class="cat-links-container" style="width: 500px;"><div class="a-column a-span6"><ul class="category-list a-nostyle a-list-link "><li><h3 class="a-spacing-small">デジタルサービス</h3></li> 
<li>
<a class="same_window" href="/gp/help/customer/display.html/ref=hp_gt_aiv?ie=UTF8&amp;nodeId=201376320" target="_self">Prime Video</a>
</li>

<li>
<a class="same_window" href="/gp/help/customer/display.html/ref=hp_gt_app?ie=UTF8&amp;nodeId=201357410" target="_self">Amazonアプリストア</a>
</li>

<li>
<a class="same_window" href="/gp/help/customer/display.html/ref=hp_gt_music?ie=UTF8&amp;nodeId=201376340" target="_self">デジタルミュージック</a>
</li>

<li>
<a class="same_window" href="/gp/help/customer/display.html/ref=hp_gt_cd?ie=UTF8&amp;nodeId=201376330" target="_self">Amazon Photos &amp; Amazon Drive</a>
</li>

<li>
<a class="same_window" href="/gp/help/customer/display.html/ref=hp_gt_gsd?ie=UTF8&amp;nodeId=201376360" target="_self">ゲーム&amp;PCソフトダウンロード</a>
</li>
 
			 
<li class="csg_more"><span class="a-color-state"> › </span> 
<a class="same_window" href="/gp/help/customer/display.html/ref=hp_gt_dsc?ie=UTF8&amp;nodeId=201376310" target="_self">すべてのデジタルサービスを見る</a>
</li>
 
		  
</ul></div><div class="a-column a-span5 a-span-last  cs-tools"><img alt="" class="csg-cat-sep" src="https://images-na.ssl-images-amazon.com/images/G/01/x-locale/cs/help/images/gateway/line.png"><ul class="category-list a-nostyle a-list-link a-spacing-top-mini"><li><h3 class="a-spacing-small">関連トピック</h3></li> 
<li>
<a class="same_window" href="https://www.amazon.co.jp/gp/help/customer/display.html?nodeId=201612980" target="_self">誤って注文したビデオのキャンセル</a>
</li>

<li>
<a class="same_window" href="https://www.amazon.co.jp/gp/help/customer/display.html?nodeId=201423000" target="_self">Prime Video（プライム会員特典について）</a>
</li>

<li>
<a class="same_window" href="https://www.amazon.co.jp/gp/help/customer/display.html?nodeId=201377820" target="_self">ダウンロードした楽曲を確認する</a>
</li>

<li>
<a class="same_window" href="https://www.amazon.co.jp/gp/help/customer/display.html?nodeId=202057960" target="_self">Amazon Music Unlimited</a>
</li>

<li>
<a class="same_window" href="https://www.amazon.co.jp/gp/help/customer/display.html?nodeId=201357490" target="_self">Amazonコインを使用する</a>
</li>
 
		  
</ul></div></div></div></div><div class="csg-hover-box-content" id="help-gateway-category-8"><div class="a-row"><div class="cat-links-container" style="width: 500px;"><div class="a-column a-span6"><ul class="category-list a-nostyle a-list-link "><li><h3 class="a-spacing-small">その他のトピックへ</h3></li> 
<li>
<a class="same_window" href="https://www.amazon.co.jp/gp/help/customer/display.html/ref=hp_gt_otsf?nodeId=201911300" target="_self">サイトの機能・サービス</a>
</li>

<li> 
<a class="same_window" href="https://www.amazon.co.jp/gp/help/customer/display.html/ref=hp_gt_otgc?nodeId=201936650" target="_self"> Amazonギフト券・ほしい物リスト・ギフト注文</a> 
</li>
 
<li> 
<a class="same_window" href="https://www.amazon.co.jp/gp/help/customer/display.html/ref=hp_gt_otodr?nodeId=201887920" target="_self">注文</a> 
</li>
 
<li>
<a class="same_window" href="https://www.amazon.co.jp/gp/help/customer/display.html/ref=hp_gt_otpri?nodeId=201895990" target="_self">価格</a>
</li>

<li> 
<a class="same_window" href="https://www.amazon.co.jp/gp/help/customer/display.html/ref=hp_gt_otpro?nodeId=201894800" target="_self">キャンペーン</a> 
</li>
 
<li> 
<a class="same_window" href="https://www.amazon.co.jp/gp/help/customer/display.html/ref=hp_gt_otmp?nodeId=201894760" target="_self">会員プログラム</a> 
</li>
 
<li> 
<a class="same_window" href="https://www.amazon.co.jp/gp/help/customer/display.html/ref=hp_gt_otsp?nodeId=201908990" target="_self">セキュリティ・規約</a> 
</li>
 
<li> 
<a class="same_window" href="https://www.amazon.co.jp/gp/help/customer/display.html/ref=hp_gt_otapv?nodeId=201994780" target="_self"> 出版社、著者、ベンダー向けガイド</a> 
</li>
 
		  
</ul></div><div class="a-column a-span5 a-span-last "><img alt="" class="csg-cat-sep" src="https://images-na.ssl-images-amazon.com/images/G/01/x-locale/cs/help/images/gateway/line.png"><ul class="category-list a-nostyle a-list-link a-spacing-top-mini"><li><h3 class="a-spacing-small">その他サービスの専用サイトへ</h3></li> 
<li> 
<a class="same_window" href="https://sellercentral.amazon.co.jp/gp/help/external/home?ref=mpbc_soaamz_cont_landing" target="_self">Amazonマーケットプレイスに出品 </a> 
</li>
 
<li> 
<a class="same_window" href="https://affiliate.amazon.co.jp/gp/associates/help/main.html/ref=hp_gt_ohassoc" target="_self"> アソシエイト（アフィリエイト）</a> 
</li>
 
<li> 
<a class="same_window" href="https://aws.amazon.com/jp?ref=hp_gt_ohaws" target="_self"> アマゾン ウェブ サービス（AWS）</a> 
</li>
 
<li> 
<a class="same_window" href="/gp/help/customer/display.html/ref=hp_gt_ohapv?ie=UTF8&amp;nodeId=201994780" target="_self"> 著者、ベンダー向けヘルプ</a> 
</li>
 
		  
</ul></div></div></div></div><div class="csg-hover-box-content" id="help-gateway-category-9"><div class="a-row"><img class="csg-hb-promo" src="https://images-na.ssl-images-amazon.com/images/G/01/support_images/GUID-E69201DE-CCF8-4E3D-9270-1C4EDD8D7791_ja-JP.png"><div class="cat-links-container" style="width: 500px;"><div class="a-column"><ul class="category-list a-nostyle a-list-link "><li><h3 class="a-spacing-small">問題が解決しない場合は</h3></li> 
<li>
<a class="same_window" href="/gp/help/customer/display.html/ref=hp_gt_rewajp?nodeId=201889530" target="_self">はじめてのお客様へ</a>
</li>
 
<li> 
<a class="same_window" href="/gp/digital/fiona/manage/ref=hp_gt_nmhmyd" target="_self"> コンテンツと端末の管理</a> 
</li>
 
<li> 
<a class="same_window" href="/gp/help/customer/display.html/ref=hp_gt_nmhcs?nodeId=201889690" target="_self"> 出品者に連絡</a> 
</li>
 
<li class="help-display-cond help-display-cond-hidden help-display-cond-rule-platform-DesktopBrowser"> 
<a class="same_window" href="/gp/help/customer/contact-us/ref=hp_gt_nmhcu" target="_self">カスタマーサービスに連絡</a> 
</li>
...
<ul class="cs-alerts category-list a-nostyle a-list-link" id="GUID-2C704095-C8EF-4E23-A9BA-0E97BB3C6976__UL_CAC29F6E418A4B5A9D68D109F82EEA6A" style="display: none;"> 
<li class="cs-warning"></li>
 
	 
</ul>
 
	 
<dl class="cs-menu" style="display: none;"> 
		 
<dt>よくある質問</dt>
 
<dd dir="-dita-use-conref-target">
      
		  
<h3 class="cs-menu-head cs-highlight">お困りですか？</h3>
      
		  

      
		  <ul id="GUID-2C704095-C8EF-4E23-A9BA-0E97BB3C6976__UL_799CD5B7BF0945A3A214C253C990C1FF" class="category-list a-nostyle a-list-link"> 
<li>
<a class="same_window cs-override-recommended" href="https://www.amazon.co.jp/gp/help/customer/display.html/ref=hp_gt_faq_rewms?nodeId=201910530" target="_self">•　最新の配送状況を確認したい</a>
</li>
...
<div class="cs-submenu-additional cs-tools">
        
		  
<h3 class="cs-menu-head">お手続きはこちらから</h3> 
		  
<ul id="GUID-2C704095-C8EF-4E23-A9BA-0E97BB3C6976__UL_09DEAD0EB6DF46E691DBE605243429DA" class="category-list a-nostyle a-list-link"> 
<li> 
<a class="same_window" href="/gp/css/order-history/ref=hp_gt_qstyp" target="_self">注文内容の確認・変更・キャンセル </a> 
</li>
...
<dt class="cs-menu-expanded">
<a class="same_window" href="https://www.amazon.co.jp/gp/help/customer/display.html/ref=hp_gt_sp?nodeId=201910060" target="_self">配送料・配送オプション</a>
</dt>
 
<dd> 
<h3 class="cs-menu-head">配送料・配送オプション</h3>
 
		  <ul id="GUID-2C704095-C8EF-4E23-A9BA-0E97BB3C6976__UL_95A935D9AE554BD39F4FA985520B71B1" class="category-list a-nostyle a-list-link"> 
<li>
<a class="same_window" href="https://www.amazon.co.jp/gp/help/customer/display.html/ref=hp_gt_spsr?nodeId=201911210" target="_self">配送料について</a> 
</li>
...
<dt class="cs-menu-expanded">
<a class="same_window" href="https://www.amazon.co.jp/gp/help/customer/display.html/ref=hp_gt_rr?nodeId=201819090" target="_self">返品・返金</a>
</dt>
 
<dd> 
<h3 class="cs-menu-head">返品・返金</h3>
 
		  <ul id="GUID-2C704095-C8EF-4E23-A9BA-0E97BB3C6976__UL_EBD9892A74EA4CA7BF9D17088B3688F9" class="category-list a-nostyle a-list-link">  
...
<dt class="cs-menu-expanded">
<a class="same_window" href="https://www.amazon.co.jp/gp/help/customer/display.html/ref=hp_gt_pm?nodeId=201894900" target="_self">支払い方法</a>
</dt>
 
<dd> 
<h3 class="cs-menu-head">支払い方法</h3>
 
		  <ul id="GUID-2C704095-C8EF-4E23-A9BA-0E97BB3C6976__UL_2A9D5640C6E5495AB494133E810DD1DB" class="category-list a-nostyle a-list-link"> 
<li>
<a class="same_window" href="https://www.amazon.co.jp/gp/help/customer/display.html/ref=hp_gt_pmcvs?nodeId=202107340" target="_self">コンビニ・ATM・ネットバンキング・電子マネー払いについて</a> 
</li>
...
<dt class="cs-menu-expanded"> 
<a class="same_window" href="https://www.amazon.co.jp/gp/help/customer/display.html/ref=hp_gt_myo?nodeId=201945500" target="_self">注文の変更・キャンセル</a>
</dt>
 
<dd> 
<h3 class="cs-menu-head cs-highlight">注文の変更・キャンセル</h3>

      
		  <ul id="GUID-2C704095-C8EF-4E23-A9BA-0E97BB3C6976__UL_11374D1995A944DABFB1924BD366754F" class="category-list a-nostyle a-list-link"> 
<li>
<a class="same_window" href="https://www.amazon.co.jp/gp/help/customer/display.html/ref=hp_gt_myocio?nodeId=201976060" target="_self">注文のキャンセル</a> 
</li>
...
<dt class="cs-menu-expanded">
<a class="same_window" href="/gp/help/customer/display.html/ref=hp_gt_mya?ie=UTF8&amp;nodeId=201945240" target="_self">登録情報の管理</a>
</dt>
 
<dd> 
<h3 class="cs-menu-head">登録情報の管理</h3> 
		  
 
		  <ul id="GUID-2C704095-C8EF-4E23-A9BA-0E97BB3C6976__UL_D4E0572F6D954A58980A1F6815C2394E" class="category-list a-nostyle a-list-link"> 
<li> 
<a class="same_window" href="https://www.amazon.co.jp/gp/help/customer/display.html/ref=hp_gt_myacas?nodeId=201945280" target="_self"> アカウント設定の変更</a> 
</li>
...
<dt class="cs-menu-expanded">
<a class="same_window" href="/gp/help/customer/display.html/ref=hp_gt_kin?nodeId=200127470" target="_self">Amazonデバイス</a>
</dt>
 
<dd> 
<h3 class="cs-menu-head">Amazonデバイス</h3> 
		  
 
		  <ul id="GUID-2C704095-C8EF-4E23-A9BA-0E97BB3C6976__UL_124FC5909D684EC79753A41778CBF2AE" class="category-list a-nostyle a-list-link"> 
<li rel="#help-gateway-menu-sub-img-0"> 
<a class="same_window" href="https://www.amazon.co.jp/gp/help/customer/display.html?nodeId=202010090" target="_self">Echo Dot</a></li>
...
<div class="cs-submenu-additional cs-tools"> 
<h3 class="cs-menu-head">関連トピック</h3> 
		  
<ul id="GUID-2C704095-C8EF-4E23-A9BA-0E97BB3C6976__UL_F70203070CB74D4C8BCCE91FC4B65D8D" class="category-list a-nostyle a-list-link"> 
<li>
<a class="same_window" href="https://www.amazon.co.jp/gp/help/customer/display.html?nodeId=201952240" target="_self">Alexa ヘルプ</a>
</li>
...
<dt class="cs-menu-expanded">
<a class="same_window" href="/gp/help/customer/display.html/ref=hp_gt_dc_kin?ie=UTF8&amp;nodeId=201706240 " target="_self">デジタルサービス</a>
</dt>
 
<dd>
<h3 class="cs-menu-head">デジタルサービス</h3> 
		  
 
		  <ul id="GUID-2C704095-C8EF-4E23-A9BA-0E97BB3C6976__UL_75AED88010F94B479EF07B1A8F22A5DE" class="category-list a-nostyle a-list-link"> 
<li>
<a class="same_window" href="/gp/help/customer/display.html/ref=hp_gt_aiv?ie=UTF8&amp;nodeId=201376320" target="_self">Prime Video</a>
</li>
...
<ul id="GUID-2C704095-C8EF-4E23-A9BA-0E97BB3C6976__UL_654819820CA54155B6817B85317A2D66" class="category-list a-nostyle a-list-link"> 
<li>
<a class="same_window" href="https://www.amazon.co.jp/gp/help/customer/display.html?nodeId=201612980" target="_self">誤って注文したビデオのキャンセル</a>
</li>
...
<dt class="cs-menu-expanded">その他</dt>
 
<dd> 
<h3 class="cs-menu-head cs-highlight">その他のトピックへ</h3> 
		  
<ul id="GUID-2C704095-C8EF-4E23-A9BA-0E97BB3C6976__UL_12DC58089C724C269CC1AD519C0875D7" class="category-list a-nostyle a-list-link"> 
<li>
<a class="same_window" href="https://www.amazon.co.jp/gp/help/customer/display.html/ref=hp_gt_otsf?nodeId=201911300" target="_self">サイトの機能・サービス</a>
</li>
...
<div class="cs-submenu-additional"> 
<h3 class="cs-menu-head cs-tools">その他サービスの専用サイトへ</h3> 
		  
<ul id="GUID-2C704095-C8EF-4E23-A9BA-0E97BB3C6976__UL_97FAF6A95DD3458FA6E8267A81B95B5F" class="category-list a-nostyle a-list-link"> 
<li> 
<a class="same_window" href="https://sellercentral.amazon.co.jp/gp/help/external/home?ref=mpbc_soaamz_cont_landing" target="_self">Amazonマーケットプレイスに出品 </a> 
</li>
...
<dt class="cs-menu-expanded">問題が解決しない場合は</dt>
 
<dd> 
<h3 class="cs-menu-head">問題が解決しない場合は</h3> 
		  
 
		  <ul id="GUID-2C704095-C8EF-4E23-A9BA-0E97BB3C6976__UL_061C2F063AF948E99177D0C15A8F844E" class="category-list a-nostyle a-list-link"> 
<li>
<a class="same_window" href="/gp/help/customer/display.html/ref=hp_gt_rewajp?nodeId=201889530" target="_self">はじめてのお客様へ</a>
</li>
...
<ul class="cs-spotlights category-list a-nostyle a-list-link" id="GUID-2C704095-C8EF-4E23-A9BA-0E97BB3C6976__UL_38CDD427E60F406E8FECFF32CAC525EC" style="display: block;"> 
<li></li>
...
</div><div id="csg-search-cu" class="a-section a-spacing-large">
<a class="same_window" href="" target="_self"></a>
...
<img onload="if (typeof uet == 'function') { uet('cf'); }" src="https://images-fe.ssl-images-amazon.com/images/G/09/x-locale/common/transparent-pixel._CB386942697_.gif" width="1" alt="" height="1" border="0"><img onload="if (typeof uet == 'function') { uet('cf'); }" src="https://images-fe.ssl-images-amazon.com/images/G/09/x-locale/common/transparent-pixel._CB386942697_.gif" width="1" alt="" height="1" border="0">
</div>                                                                                                                                          
...
<a href="/gp/customer-preferences/select-language/ref=footer_lang?ie=UTF8&amp;preferencesReturnUrl=%2Fgp%2Fhelp%2Fcustomer%2Fdisplay.html%3Fie%3DUTF8%26nodeId%3D642938" class="icp-button a-declarative" id="icp-touch-link-language">
...
<a href="/gp/navigation-country/select-country/ref=?ie=UTF8&amp;preferencesReturnUrl=%2Fgp%2Fhelp%2Fcustomer%2Fdisplay.html%3Fie%3DUTF8%26nodeId%3D642938" class="icp-button a-declarative" id="icp-touch-link-country">
...
P.when('jQuery', 'ready').execute(function(jQuery) {
    jQuery('a.expander').bind(
        'click',
        function(event) {
            event.preventDefault();
            jQuery(this).parent().next().children().toggleClass('cs-none');
            jQuery(this).toggleClass('close');
        }
    );
});

P.when('jQuery', 'a-popover', 'ready').execute(function(jQuery, popover) {
    jQuery('.cs-help-pop-link').each(function() {
        var localContent = jQuery(this).attr('name') + '-content';
        if (localContent) {
            jQuery(this).addClass('cs-link-hover');
...
<div class="playlist-initial-video hidden" data-initial-video-id="" data-autoplay=""> </div>


<script>
  (window.AmazonUIPageJS ? AmazonUIPageJS : P).load.js('https://images-fe.ssl-images-amazon.com/images/I/31wsThiK9%2BL.js?AUIClients/CSHelpVideoPlayerJS');
</script>



<script type="text/javascript">
    P.when('jQuery', 'cs-retail-help-autocomplete').execute( function(jQuery, helpCSTools) {
        var searchBoxId = 'helpsearch';
        var hiddenInputId = 'searchAutocomplete';
        var submitButtonId = 'helpSearchSubmit';
        jQuery( 'form[name="search-help"]' ).each( function( index ){
            var searchFormJQ = jQuery( this );
            var suggestionsFieldName = index + '-suggestions';
            helpCSTools[ suggestionsFieldName ] = new helpCSTools.searchSuggest( searchFormJQ, searchBoxId, hiddenInputId, submitButtonId );
            helpCSTools[ suggestionsFieldName ].init();
        });
    });
</script>

<script>
  (window.AmazonUIPageJS ? AmazonUIPageJS : P).load.js('https://images-fe.ssl-images-amazon.com/images/I/21qDdiUyQlL.js?AUIClients/CSHelpSearchAutocompleteJS');
</script>


<script>
  (window.AmazonUIPageJS ? AmazonUIPageJS : P).load.js('https://images-fe.ssl-images-amazon.com/images/I/3155KS3u9mL.js?AUIClients/CSHelpGatewayJS');
</script>
...
var ue_pty='GPHelp', ue_spty='Gateway', ue_pti='508510';

</script>

<a href="/gp/help/customer/display.html/uedata/unsticky/356-1298069-6592723/GPHelp/ntpoffrw?tepes=1&amp;id=GS11C6Q0922HC0M7BYN7">v</a>
<noscript>
     <img src='/gp/help/customer/display.html/uedata/unsticky/356-1298069-6592723/GPHelp/ntpoffrw?noscript&amp;id=GS11C6Q0922HC0M7BYN7&amp;pty=GPHelp&amp;spty=Gateway&amp;pti=508510' />
     <img src='//fls-fe.amazon.co.jp/1/batch/1/OP/A1VC38T7YXB528:356-1298069-6592723:GS11C6Q0922HC0M7BYN7$uedata=s:%2Fgp%2Fhelp%2Fcustomer%2Fdisplay.html%2Fuedata%2Funsticky%2F356-1298069-6592723%2FGPHelp%2Fntpoffrw%3Fnoscript%26id%3DGS11C6Q0922HC0M7BYN7%26pty%3DGPHelp%26spty%3DGateway%26pti%3D508510:2000' />
